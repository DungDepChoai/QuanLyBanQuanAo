...
namespace _1.DAL.ConText
{
    public class DUAN1DBContext : DbContext
    {
        ...
        {
            dbContextOptionsBuilder.UseSqlServer(@"Data Source=NGUYENQUANGDUNG\SQLEXPRESS;Initial Catalog=databasecuoicung;Persist Security Info=True; User ID =lala; Password =123");
        }
